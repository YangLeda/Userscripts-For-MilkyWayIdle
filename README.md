...
Included here are tools for the game MilkyWayIdle.

## Language Support
This script has both English & Chinese language options. 本插件是中文的。

## Features
#### Production/Market/Moneymaking Features
...
![til](https://raw.githubusercontent.com/brothers-morrison/Userscripts-For-MilkyWayIdle/master/screenshots/2026-01-15_MWITools_DPS_Popup.png)
#### Combat Features
- Shows combat DPS summary.
- Shows combat maps index.
- Shows required item levels on item icons.
- Shows how many ability books are needed to reach a certain level.
- Shows market equipment filters.


# Links to Great Additional Tools & Utilities
*Thanks to the community for putting these together!*

## Mooneycalc-Importer
MWITools (This script) imports player info to the following websites with one click of a button:
