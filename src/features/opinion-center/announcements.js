  ...
  Object.freeze({
    ...
    body: Object.freeze({
      zh: Object.freeze([
        ...
        "修复切换到技能页再返回库存后，战斗与生活着装评分、总资产可能被残留的隐藏状态遮住；库存面板现在交由游戏统一显隐，即使复用旧节点也会自动清除摘要和排序栏的残留隐藏状态。",
      ...
      en: Object.freeze([
        ...
        "Fixed combat and skilling gear scores and total assets being obscured by a stale hidden state after switching to Abilities and returning to Inventory. The game now controls visibility for the Inventory panel, while MWITools clears stale hidden states from the summary and sorting bar even when the previous node is reused.",
