  ...
  Object.freeze({
    ...
    body: Object.freeze({
      zh: Object.freeze([
        ...
        "生产详情右上角新增手动“更新仓库”按钮，会直接读取游戏当前仓库，并按最新库存重算生产余缺与购物车中的项目采购缺口；手工购物数量保持不变，常备阈值、项目占用和已计算规划也会收到库存更新，避免材料已消耗后仍显示旧余量。按钮固定在生产弹窗边框内，不会下推页面或改变弹窗原有的悬浮定位；游戏弹窗没有自带定位基准时也会正确显示，持续重绘时会保留该定位基准，不再与页面右上角来回切换闪烁。",
      ]),
      en: Object.freeze([
